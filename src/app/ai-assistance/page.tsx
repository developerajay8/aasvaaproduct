...
const Page = () => {
  ...
  return (
    <div className="w-full h-screen overflow-hidden flex">
      ...
      <div className="bg-[#1E1E1E] py-[24px] px-[24.5px] flex flex-col justify-between overflow-y-auto transition-all duration-500 ease-in-out w-[7%]">
        <Header />
      </div>

      {/* Main Section */}
      <div className="flex-1 bg-[#F9F9F9] h-screen flex transition-all duration-500 ease-in-out relative">
        
        <Sidebar/>

        {/* Right Content Section */}
        <div className="flex-1 flex flex-col pt-[30px] transition-all duration-500 ease-in-out">
          <Upgrade />
          ...
          <div className="flex-grow flex flex-col justify-center items-center">
            <div className="w-full max-w-[1049px] mx-auto px-4 py-10">
              ...
              <div className="max-w-[993px] mx-auto">
                <div className="bg-[#E3E3E3] border border-[#d7d7d7] rounded-[12px] px-4 mx-[48px] py-2">
                  <div className="pb-8">
                    <input
                      type="text"
                      value={query}
                      ...
                      className="flex-1 bg-transparent outline-none text-sm md:text-base text-black placeholder-gray-500 w-full"
                    />
                  </div>
              ...
              <div className="pt-4 flex justify-center gap-2">
                <span className="py-[12px] rounded-full px-[16px] text-[#515151] text-[14px] bg-[#E3E3E3]">
